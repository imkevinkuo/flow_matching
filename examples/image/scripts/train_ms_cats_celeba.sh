...
python $base_folder/submitit_train.py \
  ...
  --job_dir=$base_folder/checkpoint/${user}/experiments/ms_cats_celeba_${max_examples}_${image_size} \
  # --resume=$base_folder/checkpoint/${user}/experiments/ms_cats_celeba_${max_examples}_${image_size}/checkpoint.pth