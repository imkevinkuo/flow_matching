...
python $base_folder/submitit_train.py \
  --dataset=celeba \
  --celeba_attributes=scripts/attribute_mappings/female_glasses.json \
  ...
  --job_dir=$base_folder/checkpoint/${user}/experiments/celeba_female_glasses_${max_examples}_${image_size} \
  # --resume=$base_folder/checkpoint/${user}/experiments/celeba_female_glasses_${max_examples}_${image_size}/checkpoint.pth